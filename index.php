        ...
        <div id="settings">
			...
			<div id="settings-difficulty">
				...
				<p>
					...
					<span>Компьютер будет ошибаться чаще.Выиграть в этом режиме значительно проще.</span>
					<a href="#" data-difficulty="1" class="active">
						Стандартная
					</a>
					<span style="left: 108px;">Стандартный режим сложности.Чтобы победить придется постараться.</span>
				</p>
			</div>
